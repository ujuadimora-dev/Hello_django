...
# SECRET_KEY = 'django-insecure-(gjxc=o1h7ry8!j5sy3yylsmh=!w3$pujpg+$p0d9i6$q_*vhc'
...
if development:
    ...
    ALLOWED_HOSTS = ['what-todo-app-02e03e363fc8.herokuapp.com','8000-ujuadimorad-hellodjango-h4ynaloledu.ws-eu105.gitpod.io']
